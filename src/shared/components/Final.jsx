...
const Final = () => {
  return (
    <footer className="bg-gray-50 border-t-2 border-purple-400 pt-8 pb-2 px-4 md:px-16">
          ...
          <div className="w-full md:w-1/3 flex flex-col items-end">
            <form className="flex w-full max-w-xs">
              <input
                ...
                className="flex-1 border border-gray-300 rounded-l px-4 py-2 focus:outline-none bg-white"
              />
              <button
                type="submit"
