            ...
            <nav className="px-4 md:px-8 py-3 md:py-4">
                <div className="flex justify-between items-center w-full">
                    ...
                    <div className="hidden md:flex items-center gap-4 md:gap-6">
                        <NavLink to="/contact" className={({isActive}) => `text-xs md:text-sm font-medium ${isActive ? 'text-orange-700' : 'text-white'} hover:text-orange-700 transition`}>Contact Us</NavLink>
                        <NavLink to="/about" className={({isActive}) => `text-xs md:text-sm font-medium ${isActive ? 'text-orange-700' : 'text-white'} hover:text-orange-700 transition`}>About</NavLink>
                        <NavLink to="/stories" className={({isActive}) => `text-xs md:text-sm font-medium ${isActive ? 'text-orange-700' : 'text-white'} hover:text-orange-700 transition`}>Evenworld Stories</NavLink>
                    </div>
                    ...
                    <Link to="/" className="flex items-center">
                        <span className="text-xl md:text-2xl font-bold tracking-widest text-white">EVERLANE</span>
                    </Link>
